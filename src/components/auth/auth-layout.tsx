  ...
  return (
    <div className="relative min-h-dvh">
      ...
      <div className="flex min-h-dvh flex-col lg:ml-[52%]">
        <div className="flex flex-1 flex-col justify-center overflow-y-auto bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 px-6 py-10 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 sm:px-10 lg:px-16 xl:px-24">
          <AuthMobileHeader />
